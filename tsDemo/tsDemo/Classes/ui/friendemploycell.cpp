...
void FriendEmployCell::setFriendInfo(friendinfo *info)
{
    ...
    name = CCLabelTTF::create(info->name.c_str(), "hycc.ttf", 18, CCSizeMake(150, 20), kCCTextAlignmentCenter);
    //CCLabelTTF::create(info->name.c_str(), "Verdana", 18);
    ...
    price = CCLabelTTF::create(tmp, "hycc.ttf", 18, CCSizeMake(150, 20), kCCTextAlignmentRight);
    //CCLabelTTF::create(tmp, "Verdana", 18);
